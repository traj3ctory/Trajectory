	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="userName" class="col-sm-3 control-label">User Name: </label>
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="userName" placeholder="User Name" name="userName" autocomplete="on">
				    </div>
	        </div> <!-- /form-group-->	    
	        ...
	        <div class="form-group">
	        	<label for="uemail" class="col-sm-3 control-label">Email: </label>
				    ...
				    <div class="col-sm-8">
				      <input type="email" class="form-control" id="uemail" placeholder="Email" name="uemail" autocomplete="on">
				    </div>
	        </div> <!-- /form-group-->	 
