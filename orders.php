    ...
    ?>
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
				<!-- remove "value="<?php // echo date("Y-m-d"); ?>" readonly" in the input section to add previous order -->
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" value="<?php echo date("Y-m-d"); ?>" readonly />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Client Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client Contact</label>
			    <div class="col-sm-10">
			      <input type="number" class="form-control" id="clientContact" name="clientContact" placeholder="+234 ..." autocomplete="on" />
			    </div>
			  </div> <!--/form-group-->
<div class="table-responsive table-bordered px-4 mb-5 card" id="productTable">
...
$arrayNumber++;
    ...
    ?>
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst">VAT 5%</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentPlace" id="paymentPlace" readonly>
				      	<!-- <option value="">~~SELECT~~</option> -->
				      	<option value="1" selected>Mrs Oduware Store</option>
				      	<!-- <option value="2">Uniben environs</option> -->
				      </select>
				    </div>
				  </div> <!--/form-group-->
			  </div> <!--/col-md-6-->
			  ...
			  <div class="form-group submitButtonFooter">
			    <div class="col-sm-offset-5 col-sm-9 mt-4">
...
// /else manage order
    ...
    ?>
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Client Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client Contact</label>
...
$arrayNumber++;
    ...
    ?>
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst"><?php if ($data[13] == 2) {echo "VAT 7%";} else {
        echo "VAT 5%";
    }
    ?></label>
				    <div class="col-sm-9">
				  ...
				  <!-- <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="hidden" class="form-control" id="gstn" name="gstn" value="<?php //echo $data[14] ?>"  />
				    </div>
				  </div> -->
				  <!--/form-group-->
			  </div> <!--/col-md-6-->
