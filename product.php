    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="div-action enD" style="padding-bottom:20px;">
            ...
            <form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST"
                ...
                <div class="modal-body" style="max-height:450px; overflow:auto;">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label">: </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="rate" placeholder="&#8358; Amount" name="rate"
                                autocomplete="off">
                        </div>
                    </div> <!-- /form-group-->
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="productInfo">
                            <form class="form-horizontal" id="editProductForm" action="php_action/editProduct.php"
                                ...
                                <div class="form-group">
                                    <label for="editRate" class="col-sm-3 control-label">&#8358; Amount: </label>
                                    <label class="col-sm-1 control-label">: </label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="editRate"
                                            placeholder="&#8358; Amount" name="editRate" autocomplete="off">
                                    </div>
                                </div> <!-- /form-group-->
