    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="php_action/getOrderCustReport.php" method="post"
                    id="getOrderReportForm">
                    <div class="form-group">
                        <label for="custName" class="col-sm-2 control-label">Customer Name</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="custName" name="custName" placeholder="Customer">
                                <?php $sql = "SELECT DISTINCT client_name FROM orders";
                                $query = $connect->query($sql);
                                echo "<option>~Select~</option>";
                                while ($result = $query->fetch_assoc()) {
                                    echo "<option>".$result['client_name']."</option>";
                                }
                                ?>
                            </select>
                        </div>
...
<script src="custom/js/custReport.js"></script>
